...
public class Game {
	...
	public final static int numColumnas = 9;
	...
	public boolean isFinished() {
		boolean end = false;
		if(this.winAliens() || this.winPlayer() || this.finished) {
			end = true;
		}
	...
	public void endGame() {
		this.finished = true;
		System.out.println("You have left the game. See you later, bro!");
	}
	
	//Devuelve true si han ganado los aliens
	private boolean winAliens() {
		boolean win = false;
