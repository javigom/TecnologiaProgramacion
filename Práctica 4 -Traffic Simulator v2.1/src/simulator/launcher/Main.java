...
public class Main {
	...
	private static Options buildOptions() {
		...
		cmdLineOptions.addOption(Option.builder("m").longOpt("mode").hasArg().desc("Select output mode").build());
	...
	private static void parseOutPutMode(CommandLine line) throws ParseException{
	...
	private static void startBatchMode() throws IOException {
		...
		//Si no existe fichero de salida
		if(_outFile == null) { 
			out = System.out;
		}
		...
		controller.run(_numTicks, out);
			...
			System.err.println("An error ocurred: " + e.getLocalizedMessage());
		}
