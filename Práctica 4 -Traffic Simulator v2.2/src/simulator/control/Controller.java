...
public class Controller  {
	...
	public int getTimeSlot() {
		return this.trafficSimulator.getTimeSlot();
	}
	
	public void setCorrectFileTrue() {
		this.correctFile = true;
	}
	
	public boolean getCorrectFile() {
	...
	public void restart(boolean isRestart) throws IOException {
		this.trafficSimulator.restart(isRestart);
	}
	...
	public void reportError(String err) {
		this.trafficSimulator.reportError(err);
	}
	
	public List<Event> getEvents(){
		return this.trafficSimulator.getEvents();
	}
	
	public void deleteEvent(Event e) throws Exception{
		this.trafficSimulator.deleteEvent(e);
	}
	
	public JSONObject saveStatusSim() {
		return this.trafficSimulator.saveStatusSim();
	}
